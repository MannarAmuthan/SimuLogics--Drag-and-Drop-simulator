 ...
 * @author AMUTHAN
 */
public class addmain implements Component {
 ...
 public addmain(String id) {
        this.id=id;
        in1=new Circle();
        in2=new Circle();
        out=new Circle();
        img=new Image("Images/addmain.png");
}
    ...
    public ArrayList getInputregions() {
       ...
       a.add(new XandY(out,type.output,id,2,ConnType.Numeral));
       return a;
    }
    ...
    public void setData(ArrayList<DataPocket> pocket) {
        for(int i=0;i<pocket.size();i++){
             ...
             // System.out.println("in and gate "+ no);
              ...
              if(no==2){output=pocket.get(i).getData();}
        }
